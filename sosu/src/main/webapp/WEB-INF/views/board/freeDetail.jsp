		...
		<div class="board_wrap">
			<div class="board_view_wrap">
				<div class="board_view">
					<div class="title">${map.FR_TITLE }</div>
					<div class="info">
						<dl>
							<dt>카테고리</dt>
					...
					<div class="cont">${map.FR_CONTENT }
						<c:forEach items="${Flist}" var="Flist">
							<c:if test="${Flist.F_SVNAME != '0' }">
								<center>
									<img
										src="${pageContext.request.contextPath}/resources/img/upload/${Flist.F_SVNAME }"
					...
					<div class="bt_wrap">
						...
						<c:if test="${map.M_IDX == M_IDX }">
							<a class="use_move update"
								href="/freeboard/updatefree/${map.FR_CATEGORY }/${map.FR_IDX }.sosu"
								onclick="move(this, 'in', 'FR_IDX')"> 수정하기 </a>
							<form action="/freeboard/deletefree.sosu" method="post"
